...
const NavBar = () => {
  ...
  const [mobileMenu, setMonileMenu] = useState(false);
  const toggleMenu = ()=>{
    mobileMenu ? setMonileMenu(false) : setMonileMenu(true);
  }
  ...
  return (
    ...
    <nav className={`container ${sticky  ? 'dark-nav' : ''}`}>
      ...
      <ul className={mobileMenu ? '': 'hide-mobile-menu'}>
          ...
          <li><Link to='campus' smooth={true} offset={-260} duration={500}>Campuse</Link></li>
